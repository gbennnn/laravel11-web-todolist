...
Route::get('/', [TodoController::class, 'index'])->name('home'); // mengakses method index dari TodoController
Route::post('/', [TodoController::class, 'store'])->name('home.post'); // mengakses method index dari TodoController
